...
class TtsPcmPlayer {
  ...
  _waveOutOpen = _winmm.lookupFunction<
    Uint32 Function(
      Pointer<IntPtr>,
      Uint32,
      Pointer<_WaveFormatEx>,
    ...
    int Function(Pointer<IntPtr>, int, Pointer<_WaveFormatEx>, int, int, int)
  >('waveOutOpen');
  late final int Function(Pointer<Void>, Pointer<_WaveHdr>, int)
  _waveOutPrepareHeader = _winmm.lookupFunction<
  ...
  late final int Function(Pointer<Void>, Pointer<_WaveHdr>, int) _waveOutWrite =
      ...
      >('waveOutWrite');
  late final int Function(Pointer<Void>, Pointer<_WaveHdr>, int)
  _waveOutUnprepareHeader = _winmm.lookupFunction<
    Uint32 Function(Pointer<Void>, Pointer<_WaveHdr>, Uint32),
    int Function(Pointer<Void>, Pointer<_WaveHdr>, int)
  >('waveOutUnprepareHeader');
  late final int Function(Pointer<Void>) _waveOutReset = _winmm.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('waveOutReset');
  late final int Function(Pointer<Void>) _waveOutClose = _winmm.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('waveOutClose');
  ...
  void _fillDeviceQueue() {
    ...
    final inputIdle = lastInputAt != null &&
        DateTime.now().difference(lastInputAt) > const Duration(milliseconds: 160);
