...
class ApiClient {
  ...
  /// POST /api/v1/sessions — create a new session, returns sessionId.
  ...
  /// POST /api/v1/sessions/{id}/audio — upload an audio chunk.
  ...
  /// POST /api/v1/sessions/{id}/stop — end the session.
  ...
  Stream<String> sseStream(String sessionId) async* {
    final req = http.Request('GET', Uri.parse('$baseUrl/api/v1/sessions/$sessionId/events'));
