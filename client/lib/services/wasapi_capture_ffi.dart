...
class WasapiCapture {
  ...
  void load() {
    ...
    _start = _lib.lookupFunction<Int32 Function(), int Function()>(
      'wasapi_start',
    );
    _stop = _lib.lookupFunction<Void Function(), void Function()>(
      'wasapi_stop',
    );
    _getLevel = _lib.lookupFunction<Float Function(), double Function()>(
      'wasapi_get_level',
    );
    _isCapturing = _lib.lookupFunction<Int32 Function(), int Function()>(
      'wasapi_is_capturing',
    );
    _getDiag = _lib
    ...
    _getLastError = _lib.lookupFunction<Int32 Function(), int Function()>(
      'wasapi_get_last_error',
    );
    _readAudio = _lib.lookupFunction<Int32 Function(), int Function()>(
      'wasapi_read_audio',
    );
    _getAudioData = _lib
        .lookupFunction<Pointer<Uint8> Function(), Pointer<Uint8> Function()>(
          'wasapi_get_audio_data',
        );
    _availableBytes = _lib.lookupFunction<Int32 Function(), int Function()>(
      'wasapi_available_bytes',
    );
    _loaded = true;
  }
